...
class PartnersController < ApplicationController
  ...
  def partner_params
    params.require(:partner).permit(:account_ifsc, :account_no, :allow_imps, :allow_neft, :allow_rtgs,
                                    ...
                                    :connector_account, :sender_mid, :liquity_provider_id, :anchorid, :receiver_mid,:n10_notification_enabled,:neft_limit_check,:working_day_limit,:non_working_day_limit)
  end
end
